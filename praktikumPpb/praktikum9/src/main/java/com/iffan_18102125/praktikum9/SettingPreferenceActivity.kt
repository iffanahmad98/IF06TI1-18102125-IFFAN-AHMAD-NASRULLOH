...
import com.iffan_18102125.praktikum9.databinding.ActivitySettingPreferenceBinding
...
class SettingPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == R.id.btn_save) {
            ...
            if (city.isEmpty()) {
                binding.edtCity.error = getString(R.string.field_required)
                return
            }
            ...
            saveSetting(name, email, age, phoneNo, gender, city, isLoveMU)
    ...
    private fun showPreferenceInForm() {
        ...
        binding.edtCity.setText(settingModel.city)
    ...
    private fun saveSetting(name: String, email: String, age: String, phoneNo: String, gender:String, city:String, isDark: Boolean) {
